...
//This class reads the input file, processes the commands and writes the output to the output file.
//It has a main method that reads the input file, processes the commands and writes the output to the output file.
//It uses the EmployeeManagementSystem class to manage the employees in the company.

//Purpose: This class reads the input file, processes the commands and writes the output to the output file. It has a main method that reads the input file, processes the commands and writes the output to the output file. It uses the EmployeeManagementSystem class to manage the employees in the company.
package EmployeeManagementSystem;

//imoporting the required classes
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (sc.hasNext()) {
            ...
            // Read the command line from the input file
            String command_line = sc.nextLine();

            // Split the data in the command line using the comma as the delimiter
            String[] details = command_line.split(",");

            // Check the command to call the appropriate method in the
